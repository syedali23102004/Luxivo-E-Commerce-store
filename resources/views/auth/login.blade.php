...
<head>
    ...
    <style>
        * {
        ...
        /* Same subtle texture as home page */
        body::before {
            content: '';
            position: fixed;
            top: 0; left: 0;
        ...
        /* ── Login Button — same style as "SHOP LUXURY" on home ── */
        .btn-login {
            background: #D4AF37;
        ...
        <div class="auth-card">
            ...
            <div class="form-section">
                ...
                <div class="auth-links">
                    ...
                    <div>
                        <span class="text-muted-gold">Don't have an account?</span>
