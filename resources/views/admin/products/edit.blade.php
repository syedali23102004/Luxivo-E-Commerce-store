...
@section('title', 'Edit Product - LUXIVO')
                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="product-form">
                        ...
                        <div class="mb-2">
                            ...
                            @if(str_starts_with($product->image, 'http'))
                                <img src="{{ $product->image }}" style="max-height:100px;" class="rounded">
                            @else
                                <img src="{{ asset('storage/' . $product->image) }}" style="max-height:100px;" class="rounded">
                            @endif
                        </div>
                        @endif
                        ...
                        <!-- Image Upload OR URL -->
                        <div class="mb-3">
                            <label class="form-label fw-bold text-white">Update Product Image</label>
